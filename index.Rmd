...
<br>
Par la suite, on traitera un dataset simplifié qui ne gardera que la permière sous-colonne de chaque pays, c'est-à-dire sa réserve d'or en tonnes. Il se trouve sous format csv au nom de european-reserves-by-country-simplified.csv au [lien suivant](https://github.com/Bgrondin/DVP/blob/master/european-reserves-by-country-simplified.csv).

```{r}
# Import des données
data <- read.table("https://github.com/Bgrondin/DVP/blob/master/european-reserves-by-country-simplified.csv", header = TRUE, sep = ";")
